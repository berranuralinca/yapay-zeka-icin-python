...
dizi = np.arange(1,21)
print(f"Dizi:{dizi}")
print(f"Eleman sayısı:{dizi.size}")
...
dizi_carp = dizi * 3
print(f"Çarpılmış dizi:{dizi_carp}")
...
dizi3 = np.arange(1,13)
boyut = dizi3.reshape(3,4)
print(boyut.shape)
...
print(f"2.satır:{matris[1]}")
print(f"2.sütun:{matris[:,1]}")
